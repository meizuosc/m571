...
#endif
#if defined(S5K3L2XXGE_MIPI_RAW)
    {S5K3L2XXGE_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XXGE_MIPI_RAW, S5K3L2XXGE_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L2XXLITEON_MIPI_RAW)
    {S5K3L2XXLITEON_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XXLITEON_MIPI_RAW, S5K3L2XXLITEON_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L2XXLITEONGE_MIPI_RAW)
    {S5K3L2XXLITEONGE_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XXLITEONGE_MIPI_RAW, S5K3L2XXLITEONGE_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L2XXAVC_MIPI_RAW)
    {S5K3L2XXAVC_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XXAVC_MIPI_RAW, S5K3L2XXAVC_MIPI_RAW_SensorInit},
#endif
/*IMX*/
...
#endif
#if defined(OV5670FILM_MIPI_RAW)
    {OV5670FILMMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670FILM_MIPI_RAW, OV5670FILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670TECH_MIPI_RAW)
    {OV5670TECHMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670TECH_MIPI_RAW, OV5670TECH_MIPI_RAW_SensorInit},
#endif
#if defined(OV5670AVC_MIPI_RAW)
    {OV5670AVCMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670AVC_MIPI_RAW, OV5670AVC_MIPI_RAW_SensorInit},
#endif

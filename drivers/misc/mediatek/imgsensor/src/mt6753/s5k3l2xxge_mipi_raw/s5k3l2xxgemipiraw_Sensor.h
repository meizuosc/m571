...
typedef struct imgsensor_info_struct {
    ...
    imgsensor_mode_struct slim_video;    //slim video scenario relative information
    imgsensor_mode_struct hd_720p_120fps_video;    //120fps 720p video for VT scenario relative information

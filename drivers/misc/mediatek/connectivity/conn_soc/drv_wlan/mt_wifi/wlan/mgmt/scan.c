        ...
        case ELEM_ID_VENDOR:  // ELEM_ID_P2P, ELEM_ID_WMM
            {
...
#endif /* CFG_ENABLE_WIFI_DIRECT */
                {
                    ...
                    if (prWfaIE->ucLength == 0x07)
                    {
                                    ...
                                    {
                                       //if (prWfaIE->ucOuiType == 0x07)
                                       //{
                                           prBssDesc->fgIsRalinkAp = TRUE;
                                           printk("<samp> ssid = %s, %d\n",
                                                prBssDesc->aucSSID, prBssDesc->fgIsRalinkAp);
                                       //}
                                    }
                    }
                }
    ...
    )
{
	...
	#else
	DBGLOG(SCN, INFO, ("Scanresult: SSID[%s] MAC["MACSTR"] ChannelNum = %d RCPI = %d RSSI = %ddBm\n", prBssDesc->aucSSID,

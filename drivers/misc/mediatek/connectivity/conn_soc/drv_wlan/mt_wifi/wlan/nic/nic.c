...
#ifdef MEIZU_M81
                cRssi = prEventLinkQuality->cRssi;
                cRssi = (INT_8)( ( (INT_16)(cRssi) * u2AdjustRssi) / 10 );
                printk("[WLAN] nicUpdateLinkQuality: Rssi=%d, NewRssi=%d\n",prEventLinkQuality->cRssi,cRssi);
                nicUpdateRSSI(prAdapter, eNetTypeIdx, cRssi, prEventLinkQuality->cLinkQuality);
#else

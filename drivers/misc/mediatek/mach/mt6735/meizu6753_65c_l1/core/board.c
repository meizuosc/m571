...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .boot	                = 0,
	#ifdef MEIZU_M81
	#if defined(CUST_EINT_MSDC1_INS_TYPE) && (CUST_EINT_MSDC1_INS_TYPE == 4) //High Polarity and Level Sensitive
        .cd_level             = MSDC_CD_HIGH,
	#endif
	#if defined(CUST_EINT_MSDC1_INS_TYPE) && (CUST_EINT_MSDC1_INS_TYPE == 8) //Low Polarity and Level Sensitive
        .cd_level             = MSDC_CD_LOW,
	#endif
	#else
        .cd_level             = MSDC_CD_LOW,
